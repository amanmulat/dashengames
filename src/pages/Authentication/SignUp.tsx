...
const SignUp: React.FC = () => {
  return (
    <>
      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark  min-h-[100vh] flex items-center justify-center">
